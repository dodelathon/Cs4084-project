...
public class Enemy : MonoBehaviour
{
    ...
    private GameObject Controller;      //The GameObject of which the enemy will move towards and attack
    ...
    void Attack()
    {
        var attack = Instantiate(attackBlock, attackSpawn.position, transform.rotation);
        Destroy(attack, 0.2f);
    }
